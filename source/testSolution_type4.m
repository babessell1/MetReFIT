function [passes, updatedModel, updatedModelT, updatedBlockedMets, updatedViableMets, solvedRxns] = testSolution_type4(model, modelT, blockedMets, checkMets, viableMets, testRxns, demandRxns)
...
originalBlockedLength = length(updatedBlockedMets);
for i = 1:length(testRxns(:,1))
    ...
    [tempModelT] = addReaction(updatedModelT, rxn2add, 'metaboliteList',...
                               ...
                               'upperBound', ub);
    [tempModel] = addReaction(updatedModel, rxn2add, 'metaboliteList',...
                              mets2add, 'stoichCoeffList', stoic2add,...
                              'reversible', rev, 'lowerBound', lb,...
                              'upperbound', ub);
