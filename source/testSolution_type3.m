function [passes, updatedModel, updatedModelT, updatedBlockedMets, updatedViableMets, solvedRxns] = testSolution_type3(model, modelT, blockedMets, checkMets, viableMets, testRxns, demandRxns)
