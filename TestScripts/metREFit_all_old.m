function [solvedRxns,blockedMets,viableMets] = metREFit_all(model,modelT,presentDB,superDB,orthoDB,transDB,blockedMets,viableMets,demandRxns,masterMetsDB)
...
%                     [rxnChain_2] = addFromSuper(chainMet, traceNum, viableMets,...
%                                     excludeRxns,superDB,orthoDB,presentDB);
%                 end
% 
...
%                                     if missReacts == 0
<<<<<<< HEAD
%                                         rxnChain_temp_2 = vertcat(raxnChain_1,rxnChain_2,rxnChain_3(t,:));
%                                         [solvedFlag, model, modelT, blockedMets, viableMets, solvedRxns]...
%                                             = testSolution_type4(model, modelT, blockedMets, checkMets,...
%                                                  viableMets, rxnChain_temp_2, demandRxns);          
%                                  
...
>>>>>>> af1605451f822979fe0591043fa85c86a9befbb0
